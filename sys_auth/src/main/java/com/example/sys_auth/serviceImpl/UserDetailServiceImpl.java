package com.example.sys_auth.serviceImpl;

import com.example.sys_auth.entity.Role;
import com.example.sys_auth.mapper.RoleMapper;
import com.example.sys_auth.mapper.UserMapper;
...
public class UserDetailServiceImpl implements UserDetailsService {
    ...
    public UserDetails loadUserByUsername(String userName) throws UsernameNotFoundException {
        com.example.sys_auth.entity.User user = userMapper.selectUserByName(userName);
        if (user == null) {
